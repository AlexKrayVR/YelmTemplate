...
import yelm.io.extra_delicate.databinding.CameraPreviewLayoutBinding;
import yelm.io.extra_delicate.databinding.PickStorageImageBinding;
    ...
    private static class LuminosityAnalyzer implements ImageAnalysis.Analyzer {
        ...
        public void analyze(ImageProxy image, int rotationDegrees) {
            ...
            if (currentTimestamp - lastAnalyzedTimestamp >=
                ...
                Logging.logDebug("Average Luminosity " + luma);
