...
import yelm.io.extra_delicate.databinding.ActivityNewsFromNotificationBinding;
...
public class NewsFromNotificationActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (args != null) {
            Logging.logDebug( "NewsFromNotificationActivity - id: " + args.getString("id"));
                    ...
                    public void onResponse(@NotNull Call<News> call, @NotNull final Response<News> response) {
                        if (response.isSuccessful()) {
                            if (response.body() != null) {
                                ...
                                Logging.logError("Method getNewsById() - by some reason response is null!");
                            }
                        } else {
                            Logging.logError( "Method getNewsById() - response is not successful." +
