...
import yelm.io.extra_delicate.databinding.ActivityAddressChoiseBinding;
...
public class AddressChooseActivity extends AppCompatActivity {
    ...
    private void getLocationPermission() {
        Logging.logDebug(" Method getLocationPermission() - Getting location permission");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        Logging.logDebug("Call Request Permissions Result");
    ...
    private void getAddress() {
        try {
            ...
            if (addresses.size() > 0) {
                ...
                Logging.logDebug("userAddress: " + userSelectedAddress.getThoroughfare() + userSelectedAddress.getFeatureName());
                runOnUiThread(() -> {
                    String userStreet =
                            (userSelectedAddress.getThoroughfare() == null ? "" : userSelectedAddress.getThoroughfare())
                                    + (userSelectedAddress.getThoroughfare() != null && userSelectedAddress.getFeatureName() != null ? ", " : "")
